...
/**
 * Course management hook for tenant restrictions.
 *
 * @package     local_tenant_restrictions
 * @copyright   2025 CinnaLab
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_management_hook {

    /**
     * Hook to restrict course management page access.
     */
    public static function restrict_course_management() {
        global $PAGE;
    ...
    /**
     * Hook to restrict course creation page access.
     */
    public static function restrict_course_creation() {
        global $PAGE;
     ...
     */
    public static function restrict_category_access() {
        global $PAGE;
