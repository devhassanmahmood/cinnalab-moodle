...
// Use /app/moodledata on Heroku (writable, but ephemeral - files must go to S3 immediately)
$CFG->dataroot = getenv('MOODLE_DATA_ROOT') ?: '/app/moodledata';
$CFG->admin     = 'admin';

// Ensure moodledata directory exists and is writable
